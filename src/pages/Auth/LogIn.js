...
const LogInPage = () => {
    ...
    const { formData, setFormData, logInHandler, logInErrMsg, setLogInErrMsg, guestLogInHandler } = useAuth();
            ...
            <div className="ms_auth-container b-rad1">
                ...
                <form className="ms_auth-form ms_flex">
                    ...
                    <input
                        ...
                        onChange={(e) => { setLogInErrMsg(""); setFormData({ ...formData, userEmail: e.target.value }) }}
                        required />
                    ...
                    <input
                        ...
                        onChange={(e) => { setLogInErrMsg(""); setFormData({ ...formData, userPwd: e.target.value }) }}
                        required />
